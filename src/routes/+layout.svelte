...
<div class="h-dvh w-dvw overflow-y-auto overscroll-none bg-[oklch(0.115_0.03_324)] px-4 pt-10 text-neutral-50">
	<div class="absolute top-0 left-0 h-10 w-dvw overflow-hidden">
		...
		<p
			class="absolute top-0 left-1/2 mt-1 ml-[1em] -translate-x-1/2 text-xl font-black tracking-[1em] text-neutral-50/5 select-none"
		>
			GENERATING
		</p>

		<p
			class="absolute top-0 left-1/2 mt-1 -translate-x-1/2 font-seven text-xl font-black drop-shadow-sm drop-shadow-fuchsia-700"
		>
